...
# 8. Práctica: Determinar el request y limit del pod: php-apache
...
```
hey -z 60s -q 10000 -c 100 -t 3 http://php-apache
```
...
## 8.14. Es posible que Cluster-autoscaler haya eliminado uno de los nodos para balancera la carga (workload)

## 8.15. Conclusión
- Request bajo: HPA creará la cantidad de PODS necesarios para asumir los requests y soportar los picos.
